...
public class ArrayValidador {
    public boolean validateIndexes(@NotNull Array array,
                                   @NotNull int... indexes) {
    ...
    public boolean validateIsSorted(@NotNull Array array,
    ...
    public boolean validateBinarySeachValue(@NotNull Array array,
                                      int searchValue) {
